...
<h2>De BOF pim,pam,pet </h2>
<p>Voor het genereren van de brieven hebben we je gegevens nodig. Deze worden slechts voor de duur van de sessie bewaard, en natuurlijk nooit bij ons opgeslagen. Ben je benieuwd naar eerdere ervaringen van andere mensen met de PIM,PAM, of wil je die zelf achterlaten? Kijk daarvoor eens op <a href="http://wiki.bof.nl/wiki/ervaringen">ervaringen</a>. Voor een gids die je uitlegt wat je zelf kan doen om je privacy te verbeteren, zie onze <a href="http://wiki.bof.nl/wiki/Zelfverdedigingsgids" >Zelfverdedigingsgids</a> </p>
</div>						
<ul >
			
					<li id="li_1" >
		<label class="description" for="element_1">Voornaam </label>
		<div>
		...
		<label class="description" for="element_2">Achternaam </label>
		<div>
